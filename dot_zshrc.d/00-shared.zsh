...
for _zpfn_f in "$HOME/.bashrc.d/00-colors.sh" "$HOME/.bashrc.d/05-env-generated.sh" "$HOME/.bashrc.d/50-aliases-generated.sh" "$HOME/.bashrc.d/50-aliases-power.sh" "$HOME/.bashrc.d/80-functions-common.sh"; do
